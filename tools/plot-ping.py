...
def main():
    ...
    ax.plot(series_simulation["time"], series_simulation["rtt"], label="ns-3 Simulation", color="tab:red", linewidth=2)
    ax.plot(series_emulation["time"], series_emulation["rtt"], label="Emulation", color="tab:orange", linewidth=2)
    ax.plot(series_testbed["time"], series_testbed["rtt"], label="Real Testbed", color="tab:blue", linewidth=2)
